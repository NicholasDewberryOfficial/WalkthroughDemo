...
public class getReal3DPlayerInputs : getRealUserScript, PlayerInputs {
    ...
    [Tooltip("getReal3D axis name for treadmill forward axis.")]
    public string treadmillForwardAxis = "TreadmillForward";
    [Tooltip("getReal3D axis name for treadmill right axis.")]
    public string treadmillRightAxis = "TreadmillRight";
    ...
    [Header("Sensors")]
    [Tooltip("Sensor name for treadmill.")]
    public string treadmillSensor = "Treadmill";
    ...
    public float TreadmillRightAxis {
        get {
            return getReal3D.Input.GetAxisRaw(treadmillRightAxis);
        }
    }

    public float TreadmillForwardAxis {
        get {
            return getReal3D.Input.GetAxisRaw(treadmillForwardAxis);
        }
    }
    ...
    Sensor PlayerInputs.Treadmill {
        get {
            return getReal3D.Input.GetSensor(treadmillSensor);
        }
    }
}
